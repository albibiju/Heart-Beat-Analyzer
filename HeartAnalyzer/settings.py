"""
Django settings for HeartAnalyzer project.
...
SECRET_KEY = 'django-insecure-gpa01w3me$v1$3qmv$rzvz&ntqi#st*bzb)59r3h5bu4qsg^c!'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'heartBeatReader.apps.HeartbeatreaderConfig'
]
...
ROOT_URLCONF = 'HeartAnalyzer.urls'
...
WSGI_APPLICATION = 'HeartAnalyzer.wsgi.application'
